...
class IgorLexer(RegexLexer):
    ...
    functions = (
        ...
        'StatsInvRectangularCDF', 'StatsInvSpearmanCDF', 'StatsInvtodoCDF',
        ...
        'StatsSpearmanRhoCDF', 'StatstodoCDF', 'StatstodoPDF', 'StatsTopDownCDF',
        ...
        'StrVarOrDefault', 'str2num', 'todoA', 'todoT', 'sum', 'SVAR_Exists',
