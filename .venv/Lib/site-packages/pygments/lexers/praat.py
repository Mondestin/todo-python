...
class PraatLexer(RegexLexer):
    ...
    functions_numeric = (
        ...
        'invGaussQ', 'invSigmoid', 'invtodoQ', 'length', 'ln', 'lnBeta', 'lnGamma',
        ...
        'sincpi', 'sinh', 'soundPressureToPhon', 'sqrt', 'startsWith', 'todoP',
        'todoQ', 'tan', 'tanh', 'text', 'variableExists', 'word', 'writeFile', 'writeFileLine',
